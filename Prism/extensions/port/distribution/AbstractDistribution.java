 ...
 * The communication protocol doesn't matter as long as the appropriate
 * implementation is provided for the methods specified in this abstract class.
 * 
 * @version 2.0
...
public abstract class AbstractDistribution {
	...
	/**
	 * Set the parent ExtensiblePort, which is the ExtensiblePort that is
	 ...
	 */
	public abstract Vector<AbstractConnection> getConnections();
	 ...
	 */
	public abstract AbstractConnection connect(String hostName, int portNum);
