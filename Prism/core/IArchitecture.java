 ...
 */
public interface IArchitecture extends IBrick {
	/**
	 * This method will add a brick instance to the architecture enabling it to
	 * send/recieve events from this architecture.
	 * 
	 * @param b
	 *            A brick object to be added to the architecture.
	 */
	...
	public IBrick getBrickByInstanceName(String name);
	 ...
	 * (component/connector) object. Here we also enforce topological
