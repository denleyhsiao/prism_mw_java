...
/**
 * AbstractScheduler defines an abstract class for performing architectural
 * level scheduling of events. This basically comes down to the ordering policy
...
public interface AbstractScheduler {
	 ...
	 * 
	 * @param e
	 *            Event object to be added to the list
	 */
	...
	/**
	 * Get the next message to be dispatched in an arbitrary order. The order is
	 * decided by the class implementing this interface
	 * 
